          ...
          <div>
            ...
            <div className="text-secondary small">
              {estaEntrevistado
                ...
                : 'Este hogar queda registrado para retomar luego.'}
            </div>
          </div>
            ...
            <Col md={6}>
              <Form.Group controlId={`observacion-estado-hogar-${hogar.id}`}>
                ...
                <Form.Control
                  ...
                  placeholder={
                    estaEntrevistado
                      ? 'Se habilita si el hogar queda pendiente o no entrevistado.'
                      : 'Ej: volver otro día, no atienden, se niega, referencia horaria.'
                  }
                  disabled={estaEntrevistado}
                />
                <Form.Text className="text-secondary">
                  {estaEntrevistado
                    ? 'Este campo se usa solo para hogares pendientes o no entrevistados.'
                    : 'Recomendado para retomar la carga luego. No bloquea el avance.'}
                </Form.Text>
              </Form.Group>
            </Col>
          </Row>
                ...
                <Col md={6}>
                  <Form.Group controlId={`forma-acceso-vivienda-${hogar.id}`}>
                    ...
                    <Form.Select
                      ...
                      onChange={(event) =>
                        updateField('formaAccesoVivienda', event.target.value)
                      }
                    >
                      <option value="">Seleccionar</option>
